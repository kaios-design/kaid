...
function (_React$Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      }), React__default.createElement("ul", null, menu)), React__default.createElement(SoftKey, null));
    }
  }], [{
    key: "open",
...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var actPrefixCls = "".concat(prefixCls$4).concat(isActive ? '-active' : '-inactive');
      return React__default.createElement("div", {
        onClick: this.handleClick,
        className: actPrefixCls,
        style: {
          '--tab-underline-color': focusColor
        }
      }, React__default.createElement("div", {
        className: "".concat(actPrefixCls, "-label"),
        "data-l10n-id": label
      }));
    }
  }]);
...
var prefixCls$5 = 'kai-tab-view';
var tabViewTabs = "".concat(prefixCls$5, "-tabs");
var tabViewContent = "".concat(prefixCls$5, "-content");
...
function (_React$Component) {
  ...
  function TabView(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChangeIndex", function (tabIndex) {
      _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_this), "handleTabChange", function (childIndex) {
      var getTabIndex = _this.props.getTabIndex;

      _this.setState({
        activeChild: childIndex
      });

      _this.el.children[0].children[childIndex].scrollIntoView(true);
      ...
      _this.handleChangeIndex(childIndex);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleKeyDown", function (e) {
      ...
      var activeChild = _this.state.activeChild;
      var index = activeChild;

      switch (e.key) {
        case 'ArrowRight':
          index = Math.min(index + 1, React__default.Children.count(children) - 1);

          if (activeChild !== index) {
            _this.handleTabChange(index);
          }
  ...
  _createClass(TabView, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          tabLabels = _this$props.tabLabels,
          focusColor = _this$props.focusColor,
          children = _this$props.children;
      var _this$state = this.state,
          activeTab = _this$state.activeTab,
          isTransitionDone = _this$state.isTransitionDone,
          activeChild = _this$state.activeChild;
      return React__default.createElement("div", {
        className: prefixCls$5,
        ref: function ref(node) {
        ...
        return React__default.createElement(Index, {
          ...
          index: i,
          onTabChange: _this2.handleTabChange,
          isActive: activeChild === i
        });
      })), React__default.createElement("div", {
        className: tabViewContent
